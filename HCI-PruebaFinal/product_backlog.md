...
## Personas (resumen)
- Estudiante evaluador: necesita rapidez para registrar observaciones.
- Docente supervisor: necesita visibilidad inmediata de hallazgos y mejoras.
- Moderador de pruebas: requiere contexto claro de la fase actual.
