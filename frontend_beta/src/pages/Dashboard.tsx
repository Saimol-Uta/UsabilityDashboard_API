        ...
        <div className="phase-stepper" role="list" aria-label="Progreso por fases">
            {steps.map((step, i) => (
                <div key={i} className="phase-stepper-item" role="listitem">
                    ...
                    <div className={`phase-stepper-circle ${step.done ? 'is-done' : step.active ? 'is-active' : 'is-locked'
                        }`}>
                        {step.done ? (
                    ...
                    <div className="phase-stepper-label">
                        <span className={`text-[13px] font-bold ${step.done ? 'text-emerald-700' : step.active ? 'text-blue-700' : 'text-slate-400'
                            }`}>{step.label}</span>
                        <span className={`text-[11px] ${step.done ? 'text-emerald-500' : step.active ? 'text-blue-500' : 'text-slate-400'
                            }`}>{step.subtitle}</span>
                    </div>
                </div>
            ))}
